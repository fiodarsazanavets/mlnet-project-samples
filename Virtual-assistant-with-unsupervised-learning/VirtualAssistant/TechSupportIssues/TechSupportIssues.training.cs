...
namespace TechSupportIssues.ConsoleApp
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Repos\mlnet-project-samples\Virtual-assistant\support-issues.tsv";
