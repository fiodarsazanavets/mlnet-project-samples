...
namespace MovieRecommendations.ConsoleApp
{
    public partial class MovieRecommendations
    {
        public const string RetrainFilePath =  @"C:\Repos\machine-learning-data-samples\Supervised\Recommendation\movie-ratings.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Conversion.MapValueToKey(outputColumnName:@"movieId",inputColumnName:@"movieId",addKeyValueAnnotationsAsText:false)      
                                    ...
                                    .Append(mlContext.Recommendation().Trainers.MatrixFactorization(new MatrixFactorizationTrainer.Options(){LabelColumnName=@"rating",MatrixColumnIndexColumnName=@"userId",MatrixRowIndexColumnName=@"movieId",ApproximationRank=71,LearningRate=0.03735374851294432,NumberOfIterations=53,Quiet=true}))      
