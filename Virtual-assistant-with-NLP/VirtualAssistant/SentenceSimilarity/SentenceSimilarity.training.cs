...
namespace SentenceSimilarity
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Repos\machine-learning-data-samples\Supervised\Sentence-similarity\sentence-similarity-dataset.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Regression.Trainers.SentenceSimilarity(labelColumnName: @"Similarity", sentence1ColumnName: @"Sentence1", sentence2ColumnName:@"Sentence2");
