...
namespace SentenceSimilarity
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Repos\machine-learning-data-samples\Supervised\Sentence-similarity\synthetic-sentence-similarity-dataset.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Regression.Trainers.SentenceSimilarity(labelColumnName: @"similarity_score", sentence1ColumnName: @"sentence1", sentence2ColumnName:@"sentence2");
