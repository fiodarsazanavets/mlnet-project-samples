...
namespace TextClassification
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Repos\machine-learning-data-samples\Supervised\Text-classification\small-text-classification-dataset.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Conversion.MapValueToKey(outputColumnName:@"Category",inputColumnName:@"Category",addKeyValueAnnotationsAsText:false)      
                                    .Append(mlContext.MulticlassClassification.Trainers.TextClassification(labelColumnName: @"Category", sentence1ColumnName: @"Text"))      
