...
namespace TextClassification
{
    public partial class TextClassification
    {
        ...
        private static string MLNetModelPath = Path.GetFullPath("TextClassification.mlnet");
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("Category");
            if (labelColumn == null)
            {
                throw new Exception("Category column not found. Make sure the name searched for matches the name in the schema.");
            }
