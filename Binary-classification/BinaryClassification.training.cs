...
namespace Binary_classification
{
    public partial class BinaryClassification
    {
        public const string RetrainFilePath =  @"C:\Courses\Educative\ML.NET\Data\sentiment labelled sentences\amazon_cells_labelled.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col0",outputColumnName:@"col0")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator:mlContext.BinaryClassification.Trainers.FastTree(new FastTreeBinaryTrainer.Options(){NumberOfLeaves=4,MinimumExampleCountPerLeaf=14,NumberOfTrees=306,MaximumBinCountPerFeature=213,FeatureFraction=0.581733068417029,LearningRate=0.0544939020172149,LabelColumnName=@"col1",FeatureColumnName=@"Features",DiskTranspose=false}),labelColumnName: @"col1"))      
